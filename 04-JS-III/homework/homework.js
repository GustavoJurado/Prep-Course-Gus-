...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  // solucion alterna: var mayor = Math.mac.apply(null,numeros);
  //                   return mayor;
  var numeroGrande = 0
  for (var i = 0; i < numeros.length; i++){
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  var resultadoDelaMulti = 1
  for (var i = 0; i < arguments.length; i++){
    resultadoDelaMulti = resultadoDelaMulti * arguments[i]
  }
  return resultadoDelaMulti
}
